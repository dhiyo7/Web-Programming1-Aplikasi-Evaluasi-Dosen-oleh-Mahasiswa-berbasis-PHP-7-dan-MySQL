...
if (isset($_POST['login'])) {
  ...
  $result = mysqli_query($connect, "select * from user where nim = '$user' && password = '$pass' && deleted = 0 ");
          ...
          <div class="col-md-4 panel panel-body panel-info">
            <div class="form-group">
              <div class="form-group">
                ...
                <input  type="text" class="form-control" id="nim" name="username" placeholder="Masukkan username...">
              </div>
            </div>
            <div class="form-group">
              <div class="form-group">
                <label>password</label>
                <input  type="password" class="form-control" id="nim" name="password">
              </div>
            </div>
            <center>
